...
const NTP_MESSAGE_LENGTH: usize = 48; // 12 x 4 bytes
const NTP_TO_UNIX_SECONDS: i64 = 2_208_988_800; // diff b/w 1900/1/1(NTP standard) and 1970/1/1(unix standard)
...
impl NTPMessage {
    ...
    fn parse_timestamp(&self, i: usize) -> Result<NTPTimestamp, std::io::Error> {
        let mut reader = &self.data[i..i + 8]; // slice points the first byte
